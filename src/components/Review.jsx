  ...
  return (
    <div className="flex-1 overflow-auto p-4 lg:p-8 bg-white dark:bg-transparent text-gray-900 dark:text-white">
      <h1 className="text-2xl lg:text-4xl font-bold mb-4 lg:mb-8 text-gray-900 dark:text-white">
        Hello {recentUser?.username.split(" ")[0]}, Welcome to Xavior The AI
        Essay Reviewer
      </h1>
      <p className="mb-4 text-gray-600 dark:text-gray-400">
        Upload your essay here for AI-powered review. Our system will analyze
        your essay and provide feedback on grammar, structure, and content.
      </p>
      <div className="grid gap-4 lg:gap-8 grid-cols-1 lg:grid-cols-2">
        ...
        <Card
          className={`w-full flex flex-col dark:bg-[#1b1b23] ${
            reviewResults ? "" : "justify-center items-center text-center"
          }`}
          ref={resultCardRef}
        >
          <CardHeader>
